...
@section('main')
    ...
    <form action="{{ route('offered_courses.update', $offered_courses->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="{{ $offered_courses->name }}">
                </div>
