...
@section('main')
    <div class="card">
        ...
        <div class="card-body">
            <a class="btn btn-secondary" href="{{ url('/offered_corses/create') }}">اضافة دورة</a>
                ...
                <tbody>
                    @foreach ($offerdcourses as $offerdcourse)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('offered_corses.destroy', $offerdcourse->id) }}" method="post">
                                    @csrf
                                    {{-- @method('delete') --}}

                                    <a href="{{ route('offered_corses.edit', $offerdcourse->id) }}"
