                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="text" class="form-control" name="full_name" id="full_name"
                            @if (!$errors->get('full_name')) value="{{ $member->full_name }}" @endif>
                        @error('full_name')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="text" class="form-control" name="father_name" id="father_name"
                            @if (!$errors->get('father_name')) value="{{ $member->father_name }}" @endif>
                        @error('father_name')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="text" class="form-control" name="mother_name" id="mother_name"
                            @if (!$errors->get('mother_name')) value="{{ $member->mother_name }}" @endif>
                        @error('mother_name')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="gender" id="gender" class="mt-2">
                            <option @if ($member->gender == 'ذكر') selected @endif value='ذكر'>ذكر</option>
                            <option @if ($member->gender == 'أنثى') selected @endif value='أنثى'>أنثى</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="date" class="form-control" name="dob" id="dob"
                            @if (!$errors->get('dob')) value="{{ $member->dob }}" @endif>
                        @error('dob')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="text" class="form-control" name="lob" id="lob"
                            @if (!$errors->get('lob')) value="{{ $member->lob }}" @endif>
                        @error('lob')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="marital_status" id="marital_status" class="mt-2">
                            <option @if ($member->marital_status == 'أعزب/ة') selected @endif value='أعزب/ة'>أعزب/ة</option>
                            <option @if ($member->marital_status == 'متزوج/ة') selected @endif value='متزوج/ة'>متزوج/ة</option>
                            <option @if ($member->marital_status == 'مطلق/ة') selected @endif value='مطلق/ة'>مطلق/ة</option>
                            <option @if ($member->marital_status == 'أرمل/ة') selected @endif value='أرمل/ة'>أرمل/ة</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="number" class="form-control" name="family_member" id="family_member"
                            @if (!$errors->get('family_member')) value="{{ $member->family_member }}" @endif>
                        @error('family_member')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="disability" id="disability" class="mt-2">
                            <option @if ($member->disability == 0) selected @endif value=0>لا</option>
                            <option @if ($member->disability == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="disability_type_div">
                        ...
                        <input type="text" class="form-control" name="disability_type" id="disability_type"
                            @if (!$errors->get('disability_type')) value="{{ $member->disability_type }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="disability_company_div">
                        ...
                        <select name="disability_company" id="disability_company" class="mt-2">
                            <option @if ($member->disability_company == 0) selected @endif value=0>لا</option>
                            <option @if ($member->disability_company == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="family_disability" id="family_disability" class="mt-2">
                            <option @if ($member->family_disability == 0) selected @endif value=0>لا</option>
                            <option @if ($member->family_disability == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="family_disability_type_div">
                        ...
                        <input type="text" class="form-control" name="family_disability_type"
                            ...
                            @if (!$errors->get('family_disability_type')) value="{{ $member->family_disability_type }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="number" class="form-control" name="count_of_worker" id="count_of_worker"
                            @if (!$errors->get('count_of_worker')) value="{{ $member->count_of_worker }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="father_job" id="father_job" class="mt-2">
                            <option @if ($member->father_job == 'متقاعد') selected @endif value="متقاعد">متقاعد</option>
                            <option @if ($member->father_job == 'قطاع حكومي') selected @endif value="قطاع حكومي">قطاع حكومي
                            </option>
                            <option @if ($member->father_job == 'قطاع خاص') selected @endif value="قطاع خاص">قطاع خاص
                            </option>
                            <option @if ($member->father_job == 'أعمال حرة') selected @endif value="أعمال حرة">أعمال حرة
                            </option>
                            <option @if ($member->father_job == 'فاقد للمعيل') selected @endif value="فاقد للمعيل"> فاقد
                                للمعيل
                            </option>
                            <option @if ($member->father_job == 'عاطل عن العمل') selected @endif value="عاطل عن العمل"> عاطل عن
                                العمل</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="mother_job" id="mother_job" class="mt-2">
                            <option @if ($member->mother_job == 'ربة منزل') selected @endif value="ربة منزل">ربة منزل
                            </option>
                            <option @if ($member->mother_job == 'متقاعدة') selected @endif value="متقاعدة">متقاعدة
                            </option>
                            <option @if ($member->mother_job == 'قطاع حكومي') selected @endif value="قطاع حكومي">قطاع حكومي
                            </option>
                            <option @if ($member->mother_job == 'قطاع خاص') selected @endif value="قطاع خاص">قطاع خاص
                            </option>
                            <option @if ($member->mother_job == 'أعمال حرة') selected @endif value="أعمال حرة">أعمال حرة
                            </option>
                            <option @if ($member->mother_job == 'فاقد للمعيل') selected @endif value="فاقد للمعيل"> فاقد
                                للمعيل
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="military_status_div">
                        ...
                        <select name="military_status" id="military_status" class="mt-2">
                            <option @if ($member->military_status == 'معفى') selected @endif value="معفى">معفى </option>
                            <option @if ($member->military_status == 'مسرح') selected @endif value="مسرح">مسرّح </option>
                            <option @if ($member->military_status == 'معفى وحيد') selected @endif value="معفى وحيد">معفى وحيد
                            </option>
                            <option @if ($member->military_status == 'لم يخدم/مؤجل') selected @endif value="لم يخدم/مؤجل">لم يخدم /
                                مؤجل
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="city" id="city" class="mt-2">
                            <option @if ($member->city == 'طرطوس') selected @endif value="طرطوس">طرطوس </option>
                            <option @if ($member->city == 'اللاذقية') selected @endif value="اللاذقية">اللاذقية
                            </option>
                            <option @if ($member->city == 'دمشق') selected @endif value="دمشق">دمشق</option>
                            <option @if ($member->city == 'ريف دمشق') selected @endif value="ريف دمشق">ريف دمشق
                            </option>
                            <option @if ($member->city == 'حمص') selected @endif value="حمص">حمص</option>
                            <option @if ($member->city == 'حماة') selected @endif value="حماة">حماة</option>
                            <option @if ($member->city == 'حلب') selected @endif value="حلب">حلب</option>
                            <option @if ($member->city == 'ادلب') selected @endif value="ادلب">ادلب</option>
                            <option @if ($member->city == 'السويداء') selected @endif value="السويداء">السويداء
                            </option>
                            <option @if ($member->city == 'درعا') selected @endif value="درعا">درعا</option>
                            <option @if ($member->city == 'القنيطرة') selected @endif value="القنيطرة">القنيطرة
                            </option>
                            <option @if ($member->city == 'دير الزور') selected @endif value="دير الزور">دير الزور
                            </option>
                            <option @if ($member->city == 'الحسكة') selected @endif value="الحسكة">الحسكة</option>
                            <option @if ($member->city == 'الرقة') selected @endif value="الرقة">الرقة</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-8 my-1">
                        ...
                        <input type="text" class="form-control" name="address" id="address"
                            @if (!$errors->get('address')) value="{{ $member->address }}" @endif>
                        @error('address')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="location_status" id="location_status" class="mt-2">
                            <option @if ($member->location_status == 'مقيم') selected @endif value="مقيم">مقيم </option>
                            <option @if ($member->location_status == 'وافد') selected @endif value="وافد">وافد </option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="number" class="form-control" name="phone1" id="phone1"
                            @if (!$errors->get('phone1')) value="0{{ $member->phone1 }}" @endif>
                        <ul>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="number" class="form-control" name="phone2" id="phone2"
                            @if (!$errors->get('phone2')) value="0{{ $member->phone2 }}" @endif>
                        <ul>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="number" class="form-control" name="national_id" id="national_id"
                            @if (!$errors->get('national_id')) value="{{ $member->national_id }}" @endif>
                        @error('national_id')
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="education_certificate" id="education_certificate" class="mt-2">
                            <option @if ($member->education_certificate == 'دراسات عليا') selected @endif value="دراسات عليا">دراسات عليا
                            </option>
                            <option @if ($member->education_certificate == 'جامعي') selected @endif value="جامعي">جامعي </option>
                            <option @if ($member->education_certificate == 'معهد') selected @endif value="معهد"> معهد</option>
                            <option @if ($member->education_certificate == 'تعليم ثانوي') selected @endif value="تعليم ثانوي">تعليم ثانوي
                            </option>
                            <option @if ($member->education_certificate == 'تعليم أساسي') selected @endif value="تعليم أساسي">تعليم أساسي
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="education_field_div">
                        ...
                        <input type="text" class="form-control" name="education_field" id="education_field"
                            @if (!$errors->get('education_field')) value="{{ $member->education_field }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="number" class="form-control" name="date_of_certificate" id="date_of_certificate"
                            @if (!$errors->get('date_of_certificate')) value="{{ $member->date_of_certificate }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="graduated_div">
                        ...
                        <select name="graduated" id="graduated" class="mt-2">
                            <option @if ($member->graduated == 0) selected @endif value=0>لا</option>
                            <option @if ($member->graduated == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="university_year_div">
                        ...
                        <select name="university_year" id="university_year" class="mt-2">
                            <option @if ($member->university_year == 5) selected @endif value=5>الأخيرة</option>
                            <option @if ($member->university_year == 4) selected @endif value=4>الرابعة</option>
                            <option @if ($member->university_year == 3) selected @endif value=3>الثالثة</option>
                            <option @if ($member->university_year == 2) selected @endif value=2>الثانية</option>
                            <option @if ($member->university_year == 1) selected @endif value=1>الأولى</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="icdl" id="icdl" class="mt-2">
                            <option @if ($member->icdl == 0) selected @endif value=0>لا</option>
                            <option @if ($member->icdl == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="text" class="form-control" name="other_certificates" id="other_certificates"
                            @if (!$errors->get('other_certificates')) value="{{ $member->other_certificates }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="text" class="form-control" name="previous_courses" id="previous_courses"
                            @if (!$errors->get('previous_courses')) value="{{ $member->previous_courses }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="beneficial_undp" id="beneficial_undp" class="mt-2">
                            <option @if ($member->beneficial_undp == 0) selected @endif value=0>لا</option>
                            <option @if ($member->beneficial_undp == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="current_volunteer" id="current_volunteer" class="mt-2">
                            <option @if ($member->current_volunteer == 0) selected @endif value=0>لا</option>
                            <option @if ($member->current_volunteer == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="organization_name_div">
                        ...
                        <input type="text" class="form-control" name="organization_name" id="organization_name"
                            @if (!$errors->get('organization_name')) value="{{ $member->organization_name }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <input type="text" class="form-control" name="previous_experiences" id="previous_experiences"
                            @if (!$errors->get('previous_experiences')) value="{{ $member->previous_experiences }}" @endif>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="work_now" id="work_now" class="mt-2">
                            <option @if ($member->work_now == 0) selected @endif value=0>لا</option>
                            <option @if ($member->work_now == 1) selected @endif value=1>نعم</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1" id="current_job_div">
                        ...
                        <input type="text" class="form-control" name="current_job" id="current_job"
                            @if (!$errors->get('current_job')) value="{{ $member->current_job }}" @endif>
                        @error('current_job')
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="favorite_job" id="favorite_job" class="mt-2">
                            <option @if ($member->favorite_job == 'قطاع خاص') selected @endif value="قطاع خاص">قطاع خاص
                            </option>
                            <option @if ($member->favorite_job == 'قطاع عام') selected @endif value="قطاع عام">قطاع عام
                            </option>
                            <option @if ($member->favorite_job == 'افتتاح مشروع صغير') selected @endif value="افتتاح مشروع صغير">
                                افتتاح
                                مشروع صغير</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 my-1">
                        ...
                        <select name="course_chosen_id" id="course_chosen_id" class="mt-2">
                            @foreach ($courses as $course)
                                <option @if ($member->course_chosen_id == $course->id) selected @endif value="{{ $course->id }}">
                                    {{ $course->name }}</option>
                            @endforeach
                            {{-- <option @if ($member->course_chosen_id == 1) selected @endif value=1>design</option> --}}
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-2 my-1">
                        ...
                        <input type="number" class="form-control" name="fragility_father_job" id="fragility_father_job"
                            @if (!$errors->get('fragility_father_job')) value="{{ $member->fragility_father_job }}" @endif>
                    ...
                    <div class="col-12 col-lg-2 my-1">
                        ...
                        <input type="number" class="form-control" name="fragility_mother_job" id="fragility_mother_job"
                            @if (!$errors->get('fragility_mother_job')) value="{{ $member->fragility_mother_job }}" @endif>
                    ...
                    <div class="col-12 col-lg-2 my-1">
                        ...
                        <input type="number" class="form-control" name="fragility_disability" id="fragility_disability"
                            @if (!$errors->get('fragility_disability')) value="{{ $member->fragility_disability }}" @endif>
                    ...
                    <div class="col-12 col-lg-2 my-1">
                        ...
                        <input type="number" class="form-control" name="fragility_family_member"
                            ...
                            @if (!$errors->get('fragility_family_member')) value="{{ $member->fragility_family_member }}" @endif>
                    ...
                    <div class="col-12 col-lg-2 my-1">
                        ...
                        <input type="number" class="form-control" name="fragility_family_worker"
                            ...
                            @if (!$errors->get('fragility_family_worker')) value="{{ $member->fragility_family_worker }}" @endif>
                    ...
                    <div class="col-12 col-lg-2 my-1">
                        ...
                        <input type="number" class="form-control" name="fragility_military" id="fragility_military"
                            @if (!$errors->get('fragility_military')) value="{{ $member->fragility_military }}" @endif>
